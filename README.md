...
<details> <summary><strong>Click to expand the measure inventory</strong></summary> 
Category	Measures
...
Assumptions & limitations
	...
	• Growth is a fixed compounding rate, not a fitted or capped forecast (see point 4 in the Analyst's take).
...
Author & credits
Built by Khusi Khanra — github.com/khusikhanra (credit as embedded in the dashboard's About page; update this section if that attribution needs to change).
License
This project is provided under the MIT License — feel free to fork, adapt, and reuse the pipeline structure for your own portfolio or teaching purposes. The underlying financial figures are entirely synthetic.
